        ...
        <>
            ...
            {isOnline && showWelcome && (
                <div className="flex flex-col items-center justify-center h-[75vh]">
                    {avatarSrc && (
                        <img src={avatarSrc} alt="Agent Avatar" className="w-24 h-24 rounded-xl object-cover mb-5" />
                    )}
                    <h1 className="font-heading text-2xl font-extrabold text-text-main mb-3">
                        {agentQuery.data?.name}
                    </h1>
                    <p className="text-text-secondary text-base max-w-md text-center">
